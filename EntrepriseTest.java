...
public class EntrepriseTest {
	...
	public static void main(String[] args) {
		Entreprise gouv = new Entreprise("Gouvernement Fran峚is");


		gouv.setContact(new ContactMail("gouvernement@gouv.fr"));
		
		Manager fh = new Manager("Hollande","Fran峯is",true, 1939,342,gouv);
		...
		try {
			...
			System.out.println(a.chercher("Gouvernement Fran峚is"));
			System.out.println(a.chercher("Dagot"));
			System.out.println(a.chercher("Yin"));
		}
		catch (NoContactInfoException e) {
			System.out.println("Une recherche a 巆hou�: "+e.getMessage());
		}
